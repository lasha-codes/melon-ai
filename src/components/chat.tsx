...
const Chat = () => {
  ...
  return (
    <div className='w-full h-screen flex items-center justify-center max-md:p-5'>
      <div className='w-full flex flex-col items-center gap-5 text-[#292929]'>
        ...
        <form
          ...
          className='w-[600px] bg-white rounded-xl flex flex-col items-start border border-black/10 p-5 max-md:w-full'
        >
          <textarea
            value={prompt}
